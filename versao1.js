...
function AlteraRele2(){
	...
	if(estado_2==="0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='/?2_desligar' class='botao_2'><br><br><br><br><br><br>Climatiza&ccedil&atildeo</a>";
	}else{
		document.getElementById("estado_2").innerHTML="0";
		document.getElementById("rele_2").innerHTML="<div class='rele2_desligado'></div>";
		document.getElementById("botao_2").innerHTML="<a href='/?2_ligar' class='botao_2'><br><br><br><br><br><br>Climatiza&ccedil&atildeo</a>";
		}
	}
