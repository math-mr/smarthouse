function AlteraRele1(){
	...
	if(estado==="0"){
		...
		document.getElementById("botao").innerHTML="<a href='/?desligar' class='botao'><br><br><br><br><br><br>Ilumina&ccedil&atildeo</a>";
	}else{
		document.getElementById("estado").innerHTML="0";
		document.getElementById("rele").innerHTML="<div class='rele1_desligado'></div>";
		document.getElementById("botao").innerHTML="<a href='/?ligar' class='botao'><br><br><br><br><br><br>Ilumina&ccedil&atildeo</a>";
		}
	}
...
function AlteraRele2(){
	...
	if(estado_2==="0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='/?2_desligar' class='botao_2'><br><br><br><br><br><br>Home Theater</a>";
	}else{
		document.getElementById("estado_2").innerHTML="0";
		document.getElementById("rele_2").innerHTML="<div class='rele2_desligado'></div>";
		document.getElementById("botao_2").innerHTML="<a href='/?2_ligar' class='botao_2'><br><br><br><br><br><br>Home Theater</a>";
		}
	}
...
function AlteraRele3(){
	...
	if(estado_3==="0"){
		...
		document.getElementById("botao_3").innerHTML="<a href='/?3_desligar' class='botao_3'><br><br><br><br><br><br>Climatiza&ccedil&atildeo</a>";
	}else{
		document.getElementById("estado_3").innerHTML="0";
		document.getElementById("rele_3").innerHTML="<div class='rele3_desligado'></div>";
		document.getElementById("botao_3").innerHTML="<a href='/?3_ligar' class='botao_3'><br><br><br><br><br><br>Climatiza&ccedil&atildeo</a>";
		}
	}	
...
function AlteraRele4(){
	...
	if(estado_4==="0"){
		...
		document.getElementById("botao_4").innerHTML="<a href='/?4_desligar' class='botao_4'><br><br><br><br><br><br>Irriga&ccedil&atildeo</a>";
	}else{
		document.getElementById("estado_4").innerHTML="0";
		document.getElementById("rele_4").innerHTML="<div class='rele4_desligado'></div>";
		document.getElementById("botao_4").innerHTML="<a href='/?4_ligar' class='botao_4'><br><br><br><br><br><br>Irriga&ccedil&atildeo</a>";
		}
	}	